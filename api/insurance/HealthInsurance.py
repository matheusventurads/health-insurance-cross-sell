...
class HealthInsurance:
    def __init__(self):
        self.home_path = '/home/matheus/repos/health-insurance-cross-sell/'
        self.annual_premium_scaler = pickle.load(open(self.home_path + 'src/features/annual_premium_scaler.pkl', 'rb'))
        self.age_scaler            = pickle.load(open(self.home_path + 'src/features/age_scaler.pkl', 'rb'))
        self.vintage_scaler        = pickle.load(open(self.home_path + 'src/features/vintage_scaler.pkl', 'rb'))
        self.gender_encoder        = pickle.load(open(self.home_path + 'src/features/gender_encoder.pkl', 'rb'))
        self.region_code_encoder   = pickle.load(open(self.home_path + 'src/features/region_code_encoder.pkl', 'rb'))
        self.policy_sales_encoder  = pickle.load(open(self.home_path + 'src/features/policy_sales_encoder.pkl', 'rb'))
